...
export function getThemeColors(mode: 'light' | 'dark'): Record<string, string> {
  if (mode === 'light') {
    return {
  ...
  return {
    ...
    '--card': draculaTheme.currentLine,
    '--card-foreground': draculaTheme.foreground,
    '--popover': draculaTheme.currentLine,
    '--popover-foreground': draculaTheme.foreground,
    '--primary': draculaTheme.purple,
    '--primary-foreground': draculaTheme.background,
    '--secondary': draculaTheme.pink,
    '--secondary-foreground': draculaTheme.background,
    '--muted': draculaTheme.comment,
    '--muted-foreground': draculaTheme.foreground,
    '--accent': draculaTheme.cyan,
    '--accent-foreground': draculaTheme.background,
    '--destructive': draculaTheme.red,
    '--destructive-foreground': draculaTheme.background,
    '--border': draculaTheme.currentLine,
    '--input': draculaTheme.currentLine,
    '--ring': draculaTheme.purple,
    '--chart-1': draculaTheme.cyan,
    '--chart-2': draculaTheme.green,
